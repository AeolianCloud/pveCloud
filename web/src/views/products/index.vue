  ...
  <div class="bg-white">
    ...
    <section class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <div class="mb-8 flex flex-wrap gap-3">
        ...
        <span class="rounded-full border border-neutral-300 px-4 py-2 text-xs font-black text-neutral-700">Minecraft</span>
        <span class="rounded-full border border-neutral-300 px-4 py-2 text-xs font-black text-neutral-700">Steam 游戏服</span>
        <span class="rounded-full border border-neutral-300 px-4 py-2 text-xs font-black text-neutral-700">高防节点</span>
      </div>

      <div class="grid gap-5 lg:grid-cols-4">
        <article class="rounded-[1.5rem] border border-neutral-200 bg-white p-6">
        ...
        <article class="rounded-[1.5rem] border border-neutral-950 bg-white p-6 shadow-[8px_8px_0_#111]">
          <div class="flex items-start justify-between gap-4">
            <div>
        ...
        <article class="rounded-[1.5rem] border border-neutral-200 bg-neutral-50 p-6">
          <div class="flex items-start justify-between gap-4">
            <div>
    ...
    <section class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div class="grid gap-5 lg:grid-cols-3">
        <div class="rounded-[1.5rem] border border-neutral-200 p-6">
