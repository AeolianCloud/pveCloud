...
type AdminSessionHandler struct {
	adminSessionService *adminsessionusecase.AdminSessionService
}
 ...
 */
func NewAdminSessionHandler(adminSessionService *adminsessionusecase.AdminSessionService) *AdminSessionHandler {
