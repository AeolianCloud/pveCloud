...
import (
	...
	adminauth "github.com/AeolianCloud/pveCloud/server/internal/usecase/admin/auth"
)
...
type AuthHandler struct {
	authService *adminauth.AdminAuthService
}
 ...
 */
func NewAuthHandler(authService *adminauth.AdminAuthService) *AuthHandler {
