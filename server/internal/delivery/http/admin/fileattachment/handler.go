...
type FileAttachmentHandler struct {
	fileAttachmentService *fileattachmentusecase.FileAttachmentService
}
 ...
 */
func NewFileAttachmentHandler(fileAttachmentService *fileattachmentusecase.FileAttachmentService) *FileAttachmentHandler {
