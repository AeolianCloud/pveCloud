...
type DashboardHandler struct {
	dashboardService *dashboardusecase.AdminDashboardService
}
 ...
 */
func NewDashboardHandler(dashboardService *dashboardusecase.AdminDashboardService) *DashboardHandler {
