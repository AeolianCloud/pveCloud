...
import (
	...
	webauth "github.com/AeolianCloud/pveCloud/server/internal/usecase/web/auth"
...
type UserAuthHandler struct {
	service *webauth.UserAuthService
}

/**
 * NewUserAuthHandler 创建用户端认证接口处理器。
 */
func NewUserAuthHandler(service *webauth.UserAuthService) *UserAuthHandler {
