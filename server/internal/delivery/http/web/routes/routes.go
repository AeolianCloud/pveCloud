...
func RegisterWebRoutes(group *gin.RouterGroup, app *api.App) {
	...
	protected.GET("/invoice-eligible-orders", routes.Invoice.EligibleOrders)
	protected.POST("/invoices", routes.Invoice.Create)
	protected.GET("/invoices", routes.Invoice.List)
	protected.GET("/invoices/:invoice_no", routes.Invoice.Detail)
	protected.POST("/invoices/:invoice_no/cancel", routes.Invoice.Cancel)
	protected.GET("/invoices/:invoice_no/download", routes.Invoice.Download)
